...
double tamano_capa1= 100; //this is the core total width. In our sketch is CAPA 1
...
lineadummy.pop_back();lineadummy.pop_back();lineadummy.pop_back();lineadummy.pop_back();lineadummy.pop_back();
//archivosalida<< endl;
} //for de gases
//for capa
archivosalida.close();
